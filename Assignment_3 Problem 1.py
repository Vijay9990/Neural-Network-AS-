...
# Create instances
e1 = Employee("Surya", "Family1", 70000, "Devops Engineer")
e2 = Employee("Dinesh", "Family2", 60000, "Data Engineer")
e3 = Employee("Satya","Family3",80000,"Salesforce Developer")

full_time_employee = FullTimeEmployee("SaiKumar", "Family3", 70000, "Java Developer", 60)
